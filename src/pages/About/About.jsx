    ...
    <>
        ...
        <div className="page-shell about-hero__shell">
          <div className="about-hero__content">
            ...
            <h1 className="about-hero__title">
              About PrimeVista Wealth Advisor
              <br />
              Wealth Advisors
            </h1>
      ...
      <section className="about-intro">
        <div className="page-shell about-intro__inner">
          ...
          <p className="about-intro__copy">
            Founded on the principles of transparency and intellectual rigor, PrimeVista Wealth Advisor
      ...
      <section className="about-advantage">
        <div className="page-shell">
          <h2 className="about-advantage__title">The PrimeVista Wealth Advisor Advantage</h2>
